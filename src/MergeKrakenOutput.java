 ...
 * Modified from: https://github.com/afodor/clusterstuff/blob/master/src/kw_china_wgs_kraken/MergeKrakenOutput.java
...
public class MergeKrakenOutput {
    ...
    public static void writeSplitTable(ArrayList<String> tables,
        ...
        BufferedWriter out = new BufferedWriter(new FileWriter(
                ...
                new File(DIR + QIITAID + "_" + level + ".txt")));
